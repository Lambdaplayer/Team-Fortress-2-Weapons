...
function ENT:InitEffects()
	ParticleEffectAttach( "rockettrail_!", PATTACH_POINT_FOLLOW, self, 1 )
end
...
function ENT:DoExplosion(ent)
	...
	if self.Nuke then
		...
		--[[if self.FastRocket then
			...
			self:EmitSound( "lambdaplayers/weapons/SlendytubbiesSFX's/grenade/explode"..math.random(1,3)..".mp3", 80, nil, nil, CHAN_STATIC )
		--end
