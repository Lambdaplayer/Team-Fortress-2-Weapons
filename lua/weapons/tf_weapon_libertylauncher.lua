if CLIENT then
    ...
    killicon.Add( "tf_weapon_rocketlauncher", "lambdaplayers/killicons/icon_tf2_libertylauncher", Color( 255, 255, 255, 255 ) )
    killicon.Add( "tf_projectile_rocket", "lambdaplayers/killicons/icon_tf2_libertylauncher", Color( 255, 255, 255, 255 ) )
    end
    ...
    SWEP.ViewModel = "mmodels/weapons/c_arms.mdl"
    SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_liberty_launcher.mdl"
    ...
    SWEP.Primary.Sound = Sound( "weapons/rocket_ll_shoot.wav" )
    ...
    function SWEP:Initialize()
        ...
        self.Weapon:EmitSound("weapons/rocket_ll_shoot.wav")
