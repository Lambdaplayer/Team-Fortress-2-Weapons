...
killicon.Add( "tf_weapon_club", "lambdaplayers/killicons/icon_tf2_machete", Color( 255, 255, 255, 255 ) )
end
...
SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_machete.mdl"
...
SWEP.Primary.Sound = Sound( "Weapon_Machete.Miss" )
...
self.Owner:EmitSound( "Weapon_Machete.HitFlesh" )
end
if !( tr.Entity:IsNPC() || tr.Entity:IsPlayer() ) then
self.Owner:EmitSound( "Weapon_Machete.HitWorld" )
end
end
end
self.Attack = 0
