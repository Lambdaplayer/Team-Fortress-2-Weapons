...
killicon.Add( "tf_weapon_shotgun_pyro", "lambdaplayers/killicons/icon_tf2_shotgun", Color( 255, 255, 255, 255 ) )
end
...
ParticleEffect("muzzle_shotgun", self.Owner:EyePos() + (self.Owner:EyeAngles():Right() * 10) + (self.Owner:EyeAngles():Up() * -33) + (self.Owner:EyeAngles():Forward()*36), self.Owner:EyeAngles() )
self.Idle = 0
self.IdleTimer = CurTime() + self.Owner:GetViewModel():SequenceDuration()
self.Recoil = 1
