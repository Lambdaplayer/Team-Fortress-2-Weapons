if CLIENT then
    ...
    killicon.Add( "tf_weapon_blackbox", "lambdaplayers/killicons/icon_tf2_rocketlauncher", Color( 255, 255, 255, 255 ) )
    killicon.Add( "tf_projectile_blackbox", "lambdaplayers/killicons/icon_tf2_blackbox", Color( 255, 255, 255, 255 ) )
    end
    
    SWEP.PrintName = "Black Box"
    ...
    SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_blackbox.mdl"
    ...
    SWEP.Primary.Sound = Sound( "weapons/rocket_blackbox_shoot.wav" )
    ...
    SWEP.VElements = {
        ["vm_blackbox"] = { type = "Model", model = "models/weapons/c_models/c_blackbox/c_blackbox.mdl", bone = "RL_body", rel = "", pos = Vector(0, 0, 2), angle = Angle(90, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
    }
    ...
    function SWEP:PrimaryAttack()
        ...
        if(self.Weapon:Clip1() > 0) then
            ...
            self.Weapon:EmitSound("weapons/rocket_blackbox_shoot.wav")
    ...
    function SWEP:FireRocket()
        ...
        local rocket = ents.Create("tf_projectile_blackbox")
