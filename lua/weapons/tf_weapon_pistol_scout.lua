if CLIENT then
SWEP.WepSelectIcon = surface.GetTextureID( "sprites/bucket_pistol" )
SWEP.DrawWeaponInfoBox = false
SWEP.BounceWeaponIcon = false
killicon.Add( "tf_weapon_pistol_scout", "lambdaplayers/killicons/icon_tf2_pistol", Color( 255, 255, 255, 255 ) )
end
...
SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_pistol.mdl"
...
ParticleEffectAttach("muzzle_pistol", PATTACH_POINT_FOLLOW, self.Weapon, 1)
...
timer.Simple( 0., function() self:EmitSound("weapons/pistol_worldreload.wav") end)
