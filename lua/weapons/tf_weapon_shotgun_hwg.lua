...
killicon.Add( "tf_weapon_shotgun_hwg", "lambdaplayers/killicons/icon_tf2_shotgun", Color( 255, 255, 255, 255 ) )
end
...
SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_shotgun.mdl"
...
timer.Simple( 0.1, function() self:EmitSound("weapons/draw_secondary.wav") end)
...
self.Owner:DoAnimationEvent( ACT_HL2MP_GESTURE_RELOAD_AR2 )
timer.Simple( 0.3, function() self:EmitSound("weapons/shotgun_worldreload.wav") end)
