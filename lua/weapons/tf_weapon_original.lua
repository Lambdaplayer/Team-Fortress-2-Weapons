if CLIENT then
    ...
    killicon.Add( "tf_weapon_original", "lambdaplayers/killicons/icon_tf2_original", Color( 255, 255, 255, 255 ) )
    killicon.Add( "tf_projectile_originalrocket", "lambdaplayers/killicons/icon_tf2_original", Color( 255, 255, 255, 255 ) )
    end
    ...
    SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_bet_rocketlauncher.mdl"
    SWEP.ViewModelFlip = false
    SWEP.ShowViewModel = true
    SWEP.ShowWorldModel = false
    SWEP.ViewModelBoneMods = {
	   ["root"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 100, 0), angle = Angle(0, 0, 0) },
	   ["weapon_bone"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, -1, -10), angle = Angle(-2, 20, 0) },
	   ["Rocket"] = { scale = Vector(100, 100, 100), pos = Vector(0, -1, -10), angle = Angle(0, 20, 0) }
    }
    SWEP.BobScale = 1
    SWEP.SwayScale = 0
    ...
    SWEP.Primary.Sound = Sound( "weapons/quake_rpg_fire_remastered.wav" )
    ...
    function SWEP:PrimaryAttack()
        ...
        if(self.Weapon:Clip1() > 0) then
            ...
            self.Weapon:EmitSound("weapons/quake_rpg_fire_remastered.wav")
    ...
    function SWEP:FireRocket()
        ...
        local rocket = ents.Create("tf_projectile_originalrocket")
