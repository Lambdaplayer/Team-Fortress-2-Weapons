if CLIENT then
    ...
    killicon.Add( "tf_weapon_knife", "lambdaplayers/killicons/icon_tf2_knife", Color( 255, 255, 255, 255 ) )
    end
    ...
    SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_knife.mdl"
    ...
    timer.Simple( 0., function() self:EmitSound("weapons/draw_melee.wav") end)
    timer.Simple( 0.333333, function() self:EmitSound("weapons/knife_open1.wav") end)
    timer.Simple( 0.533333, function() self:EmitSound("weapons/knife_open5.wav") end)
    timer.Simple( 0.733333, function() self:EmitSound("weapons/knife_open8.wav") end)
    ...
    ParticleEffect("crit_text", ent:EyePos() + (ent:EyeAngles():Right() * 1) + (ent:EyeAngles():Up() * 8) + (ent:EyeAngles():Forward()*1), ent:EyeAngles() )-- Angle(-90,0,0))
    ent:EmitSound("player/crit_hit"..math.Round(math.Rand(2,5))..".wav")
    ...
    if SERVER then
    self.Owner:StopSound( "Player.Spy_Grunt" )
    self.Owner:EmitSound( "Player.Spy_Grunt" )
    end
    self:SetNextSecondaryFire( CurTime() + 0.5 )
    end
    end
