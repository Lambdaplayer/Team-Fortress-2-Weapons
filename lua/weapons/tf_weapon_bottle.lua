if CLIENT then
SWEP.WepSelectIcon = surface.GetTextureID( "sprites/bucket_bottle_red" )
SWEP.DrawWeaponInfoBox = false
SWEP.BounceWeaponIcon = false
killicon.Add( "tf_weapon_bottle", "lambdaplayers/killicons/icon_tf2_bottle", Color( 255, 255, 255, 255 ) )
end
...
SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_bottle.mdl"
...
self.Owner:EmitSound( "Weapon_Bottle.HitFlesh" )
end
if !( tr.Entity:IsNPC() || tr.Entity:IsPlayer() ) then
self.Owner:EmitSound( "Weapon_Bottle.HitWorld" )
end
end
if !( tr.Entity:IsNPC() || tr.Entity:IsPlayer() ) then
self.Broken = 1
