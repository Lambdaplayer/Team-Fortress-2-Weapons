if CLIENT then
    ...
    killicon.Add( "tf_weapon_rocketlauncher", "lambdaplayers/killicons/icon_tf2_rocketlauncher", Color( 255, 255, 255, 255 ) )
    killicon.Add( "tf_projectile_rocket", "lambdaplayers/killicons/icon_tf2_rocketlauncher", Color( 255, 255, 255, 255 ) )
    end
    ...
    SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_rocket_launcher.mdl"
    ...
    function SWEP:Initialize()
        ...
        function SWEP:PrimaryAttack()
            ...
            if(self.Weapon:Clip1() > 0) then
                ...
                self.Weapon:EmitSound("weapons/rocket_shoot.wav")
