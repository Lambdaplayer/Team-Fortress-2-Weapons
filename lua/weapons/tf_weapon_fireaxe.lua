...
killicon.Add( "tf_weapon_fireaxe", "lambdaplayers/killicons/icon_tf2_fireaxe", Color( 255, 255, 255, 255 ) )
end
...
SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_fireaxe.mdl"
