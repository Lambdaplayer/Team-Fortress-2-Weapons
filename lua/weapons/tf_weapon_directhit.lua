if CLIENT then
    ...
    killicon.Add( "tf_weapon_directhit", "lambdaplayers/killicons/icon_tf2_directhit", Color( 255, 255, 255, 255 ) )
    killicon.Add( "tf_projectile_directhitrocket", "lambdaplayers/killicons/icon_tf2_directhit", Color( 255, 255, 255, 255 ) )
    end
    ...
    SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_directhit.mdl"
    ...
    SWEP.Primary.Sound = Sound( "weapons/rocket_directhit_shoot.wav" )
    ...
    SWEP.VElements = {
        ["vm_directhit"] = { type = "Model", model = "models/weapons/c_models/c_directhit/c_directhit.mdl", bone = "RL_body", rel = "", pos = Vector(0, 0, 2), angle = Angle(90, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
    }
    ...
    function SWEP:Initialize()
        ...
        function SWEP:PrimaryAttack()
            ...
            if(self.Weapon:Clip1() > 0) then
                ...
                self.Weapon:EmitSound("weapons/rocket_directhit_shoot.wav")
        ...
        local rocket = ents.Create("tf_projectile_directhitrocket")
