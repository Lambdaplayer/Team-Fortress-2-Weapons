...
killicon.Add( "tf_weapon_shovel", "lambdaplayers/killicons/icon_tf2_shovel", Color( 255, 255, 255, 255 ) )
end
...
SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_shovel.mdl"
...
SWEP.Primary.Sound = Sound( "Weapon_Shovel.Miss" )
...
self.Owner:EmitSound( "Weapon_Shovel.HitFlesh" )
end
if !( tr.Entity:IsNPC() || tr.Entity:IsPlayer() ) then
self.Owner:EmitSound( "Weapon_Shovel.HitWorld" )
end
end
end
self.Attack = 0
