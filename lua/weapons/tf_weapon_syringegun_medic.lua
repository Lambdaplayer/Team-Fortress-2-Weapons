if CLIENT then
    ...
    killicon.Add( "tf_weapon_syringegun_medic", "lambdaplayers/killicons/icon_tf2_syringegun", Color( 255, 255, 255, 255 ) )
    ...
    SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_syringegun.mdl"
