...
killicon.Add( "tf_weapon_loch_n_load", "lambdaplayers/killicons/icon_tf2_loch_n_load", Color( 255, 255, 255, 255 ) )
killicon.Add( "tf_projectile_pipe_lochnload", "lambdaplayers/killicons/icon_tf2_loch_n_load", Color( 255, 255, 255, 255 ) )
end
...
SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_lochnload.mdl"
...
SWEP.Primary.Sound = Sound( "weapons/loch_n_load_shoot.wav" )
...
if SERVER then
local entity = ents.Create( "tf_projectile_pipe_lochnload" )
