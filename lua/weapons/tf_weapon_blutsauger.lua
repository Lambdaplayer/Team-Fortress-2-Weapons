if CLIENT then
    ...
    killicon.Add( "tf_weapon_blutsauger", "lambdaplayers/killicons/icon_tf2_blutsauger", Color( 255, 255, 255, 255 ) )
    killicon.Add( "tf_projectile_syringe", "lambdaplayers/killicons/icon_tf2_syringegun", Color( 255, 255, 255, 255 ) )
    end
    
    SWEP.PrintName = "Blutsauger"
    ...
    SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_leechgun.mdl"
