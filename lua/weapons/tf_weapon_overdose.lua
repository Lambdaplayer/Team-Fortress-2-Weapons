if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID( "backpack/weapons/w_models/w_syringegun" )
    SWEP.DrawWeaponInfoBox = false
    SWEP.BounceWeaponIcon = false
    killicon.Add( "tf_weapon_overdose", "models/lambdaplayers/tf2/weapons/w_overdose.mdl", Color( 255, 255, 255, 255 ) )
    killicon.Add( "tf_projectile_syringe", "lambdaplayers/killicons/icon_tf2_syringegun", Color( 255, 255, 255, 255 ) )
    end
    
    SWEP.PrintName = "Overdose"
    ...
    SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_overdose.mdl"
    ...
    SWEP.Primary.Sound = Sound( "weapons/tf_medic_syringe_overdose.wav" )
    ...
    self:EmitSound("weapons/draw_primary.wav", 75, 85)
    ...
    ParticleEffectAttach("muzzle_syringe", PATTACH_POINT_FOLLOW, self.Weapon, 1)
    ...
    timer.Simple( 0., function() self:EmitSound("weapons/syringegun_worldreload.wav") end)
