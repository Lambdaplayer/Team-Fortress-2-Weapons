if CLIENT then
    ...
    killicon.Add( "tf_weapon_flare", "lambdaplayers/killicons/icon_tf2_flare_gun", Color( 255, 255, 255, 255 ) )
    killicon.Add( "tf_projectile_flare", "lambdaplayers/killicons/icon_tf2_flare_gun", Color( 255, 255, 255, 255 ) )
    end
    ...
    SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_flaregun.mdl"
    ...
    ParticleEffectAttach("muzzle_shotgun", PATTACH_POINT_FOLLOW, self.Weapon, 1)
    self.Weapon:SendWeaponAnim( ACT_VM_PRIMARYATTACK )
    self.Owner:DoAnimationEvent( ACT_HL2MP_GESTURE_RANGE_ATTACK_REVOLVER )
    ...
    timer.Simple( 0., function() self:EmitSound("weapons/grenade_launcher_drum_open.wav") end)
    timer.Simple( 0.2, function() self:EmitSound("weapons/grenade_launcher_drum_load.wav") end)
    timer.Simple( 0.766667, function() self:EmitSound("weapons/flaregun_tube_closestart.wav") end)
    timer.Simple( 0.833333, function() self:EmitSound("weapons/flaregun_tube_closefinish.wav") end)
