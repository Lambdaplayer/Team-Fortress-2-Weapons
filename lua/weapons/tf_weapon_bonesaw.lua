...
killicon.Add( "tf_weapon_bonesaw", "lambdaplayers/killicons/icon_tf2_bonesaw", Color( 255, 255, 255, 255 ) )
end
...
SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_bonesaw.mdl"
