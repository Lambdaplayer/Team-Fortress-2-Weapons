if CLIENT then
    ...
    killicon.Add( "tf_weapon_flamethrower", "lambdaplayers/killicons/icon_tf2_flamethrower", Color( 255, 255, 255, 255 ) )
    end
    ...
    SWEP.WorldModel = "models/lambdaplayers/tf2/weapons/w_flamethrower.mdl"
    ...
    dmg:SetDamageCustom( TF_DMG_CUSTOM_BURNING + TF_DMG_CUSTOM_IGNITE )
